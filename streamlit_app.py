...
add_my_fruit = streamlit.text_input('What fruit would vou like to add?')
if streamlit.button( "Add a Fruit to the List'):
                    mv_cnx = snowflake.connector.connect(**streamlit.secrets["snowflake" 1)
